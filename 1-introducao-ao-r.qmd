...
- [`viagens_trabalho.csv`](https://github.com/pedreirajr/bdib/releases/download/datsets/viagens_trabalho.csv)
- [`viagens_trabalho.txt`](https://github.com/pedreirajr/bdib/releases/download/datsets/viagens_trabalho.txt)
- [`viagens_trabalho.xlsx`](https://github.com/pedreirajr/bdib/releases/download/datsets/viagens_trabalho.xlsx)
- [`viagens_trabalho2.txt`](https://github.com/pedreirajr/bdib/releases/download/datsets/viagens_trabalho2.txt)
- [`viagens_trabalho3.csv`](https://github.com/pedreirajr/bdib/releases/download/datsets/viagens_trabalho3.csv)
...
url <- "https://github.com/pedreirajr/bdib/releases/download/datsets/viagens_trabalho.csv"
df <- read.csv(url)
```
...
url_txt <- "https://github.com/pedreirajr/bdib/releases/download/datsets/viagens_trabalho.txt"
...
url2 <- "https://github.com/pedreirajr/bdib/releases/download/datsets/viagens_trabalho2.txt"
url3 <- "https://github.com/pedreirajr/bdib/releases/download/datsets/viagens_trabalho3.csv"
...
library(readxl)
url_xlsx <- "https://github.com/pedreirajr/bdib/releases/download/datsets/viagens_trabalho.xlsx"
