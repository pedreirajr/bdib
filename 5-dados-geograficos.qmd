...
## Geoprocessamento com o pacote `sf` para R
...
ggplot() +
  ...
  geom_sf(data = inter_metro_bairros, fill = "steelblue", alpha = 0.6, color = NA) +
  geom_sf(data = est_metro_utm, color = "white", size = 1.5) +
  theme_minimal()
```
