...
xlim_geo <- c(-42.5, -39.0)
ylim_geo <- c(-16.5, -13.0)
...
O Brasil ocupa principalmente os fusos 19 a 25, e a escolha do fuso correto é essencial para que distâncias e áreas sejam matematicamente precisas ([Geo One](https://geoone.com.br/qual-src-devo-utilizar-em-meu-mapa/)). No exemplo da @fig-src-comparacao anterior, por exemplo, escolhemos o UTM 24S, pois é o fuso UTM onde o município de Vitória da Conquista-BA se localiza.

![Fusos UTM que cobrem o território brasileiro. Fonte: [Geo One](https://geoone.com.br/qual-src-devo-utilizar-em-meu-mapa/).](img/5-dados-geograficos/5-7-utm_brasil.jpg){#fig-utm-brasil}
