...
Os setores censitários são a unidade espacial de coleta do IBGE, desenhados para facilitar o trabalho dos recenseadores. Isso significa que seus limites não necessariamente coincidem com as unidades de análise que os pesquisadores desejam usar. Em muitos contextos, é mais conveniente trabalhar com unidades padronizadas e comparáveis entre diferentes cidades e regiões. É o caso de distritos sanitários, subprefeituras, áreas de risco de desastres ambientais ou zonas de tráfego em estudos de transporte.
