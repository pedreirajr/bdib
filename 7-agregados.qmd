...
## Produção mapas personalizados das variáveis dos Agregados
...
![Esquema da interpolação dassimétrica usando pontos de endereços do CNEFE como guia de distribuição espacial. Os dados do setor censitário são alocados aos pontos de endereço e depois agregados às unidades-alvo (hexágonos, zonas de tráfego etc.).](img/7-agregados/dasyinter.png){#fig-dasyinter}
